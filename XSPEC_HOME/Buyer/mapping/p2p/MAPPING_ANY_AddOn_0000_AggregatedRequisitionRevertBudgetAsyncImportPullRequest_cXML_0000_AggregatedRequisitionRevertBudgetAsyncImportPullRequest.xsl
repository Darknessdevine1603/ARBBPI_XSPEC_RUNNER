...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="n0:ERPRespToAribaBuyerMsg">
        <urn:AggregatedRequisitionRevertBudgetAsyncImportPullRequest>
            ...
            <xsl:choose>
                <xsl:when test="LogMessage">
                    <urn:RequisitionError_RequisitionErrorImport_Item>
                ...
                <xsl:when test="MultiHeader">
                    ...
                    <xsl:element name="urn:{MultiHeader[1]/@name}">
                        <xsl:for-each select="MultiHeader">
                            <xsl:variable name="v_headerKey"
                                select="HeaderSpecificFields/@objectKey"/>
                            <urn:item>
                                ...
                                <xsl:if test="$v_items">
                                    <xsl:element name="urn:{../Item[1]/@name}">
                                        <xsl:for-each
                                            select="$v_items[ItemSpecificFields/@objectKey = $v_headerKey]">
                                            <urn:item>
                                                <xsl:for-each select="ItemSpecificFields">
                                                  <xsl:variable name="v_fieldName"
                                                  select="@fieldName"/>
                ...
                <xsl:otherwise>
                    <urn:Requisition_AggregatedRequisitionRevertBudgetAsyncImportSuccess_Item>
                        <urn:item>
