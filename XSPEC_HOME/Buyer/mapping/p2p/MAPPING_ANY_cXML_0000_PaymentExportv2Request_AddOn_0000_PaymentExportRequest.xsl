...
<xsl:stylesheet xmlns:typens="urn:Ariba:Buyer:vsap" xmlns:n0="urn:sap-com:document:sap:rfc:functions" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsd="http://www.w3.org/2001/XMLSchema" exclude-result-prefixes="xs" version="2.0">
	<xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:strip-space elements="*"/><xsl:output method="xml" indent="no" omit-xml-declaration="yes"/> <!--<IG-37299 : XSLT Improvements>-->
<!--		    <xsl:include href="FORMAT_Apps_0000_AddOn_0000.xsl"/>-->
	...
	<xsl:variable name="v_Header" select="typens:PaymentExport_v2Request/typens:Payment_PaymentHeaderForExport_Item/typens:item"/>
	<xsl:variable name="v_GlAcc" select="typens:PaymentExport_v2Request/typens:Payment_PaymentGLAccDetForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:LineItems/typens:item/typens:Accountings/typens:SplitAccountings/typens:item"/>
	<xsl:variable name="v_GlAccMain" select="typens:PaymentExport_v2Request/typens:Payment_PaymentGLAccDetForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:LineItems/typens:item"/>
	<xsl:variable name="v_ItemData" select="typens:PaymentExport_v2Request/typens:Payment_PaymentLineItemDetForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:LineItems/typens:item"/>
	<xsl:variable name="v_AccData" select="typens:PaymentExport_v2Request/typens:Payment_EnhancedPaymentAccountDetForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:LineItems/typens:item/typens:Accountings/typens:SplitAccountings/typens:item"/>
	<xsl:variable name="v_Tax" select="typens:PaymentExport_v2Request/typens:Payment_PaymentTaxForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:TaxDistributionVector/typens:item"/>
	<xsl:variable name="v_AdvPay" select="typens:PaymentExport_v2Request/typens:Payment_AdvancePaymentDetailExport_Item/typens:item/typens:AdvancePayments/typens:item"/>
	<xsl:variable name="v_AddrData" select="typens:PaymentExport_v2Request/typens:Payment_PaymentHeaderForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:OneTimeVendorInvoiceDetail"/>
	<xsl:variable name="v_payTaxExport" select="typens:PaymentExport_v2Request/typens:Payment_PaymentTaxForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:TaxDistributionVector"/>	
	<xsl:variable name="v_matchedReceipt" select="typens:PaymentExport_v2Request/typens:Payment_PaymentMatchedReceiptsDetForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:MatchedReceipts/typens:item"/>
	...
	<!--<xsl:variable name="v_NoPoNumber" select="(typens:PaymentExport_v2Request/typens:Payment_PaymentGLAccDetForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:LineItems/typens:item/typens:ERPPONumber) = ''"/>
	...
	<xsl:variable name="v_NoPoNumber"
		select="(typens:PaymentExport_v2Request/typens:Payment_PaymentLineItemDetForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:LineItems/typens:item[1]/typens:POLineNumber) = ''"/>
	<!--End of IG-16335-->
...
<!--IG-19285-->		
		<xsl:value-of select=
			"(((typens:PaymentExport_v2Request/typens:Payment_PaymentGLAccDetForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:LineItems/typens:item
			...
			and 
			(not(exists((typens:PaymentExport_v2Request/typens:Payment_PaymentGLAccDetForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:LineItems/typens:item
			[typens:LineType/typens:Category = '4' or typens:LineType/typens:Category = '8' or typens:LineType/typens:Category = '16'] 
...
<!--IG-19285-->		
	...
	<xsl:variable name="v_DebCreInd">
		<xsl:if
			test="$v_Header/typens:InvoiceReconciliationForExport/typens:Invoice/typens:IsPriceAdjustmentInvoice = 'true'">
							...
							<xsl:variable name="v_sum">
								<xsl:for-each select="$v_GlAcc">
									<xsl:choose>
										...
										<xsl:when test="(../../../typens:LineType/typens:Category = '1' or ../../../typens:LineType/typens:Category = '4' or ../../../typens:LineType/typens:Category = '8' or ../../../typens:LineType/typens:Category = '16' or string-length(normalize-space(../../../typens:LineType/typens:Category)) = 0) and ../../../typens:NumberInCollection = $v_ParentNumberInCollection"><!--<IG-37299 : XSLT Improvements >-->
											<value>
	...
	<xsl:variable name = "v_taxsource">
		<xsl:value-of select="typens:PaymentExport_v2Request/typens:Payment_PaymentHeaderForExport_Item/typens:item/typens:InvoiceReconciliationForExport/typens:TaxSource"/>
	</xsl:variable>
	<xsl:template match="/">
		<n0:ARBCIG_BAPI_INVOICE_CREATE>
			<!--<IG-37299 : XSLT Improvements, Rearranging tags >-->
			...
			<!-- End of Address Data -->
			<!--       Attachment code     -->
			<xsl:if test="/typens:PaymentExport_v2Request/typens:Payment_PaymentAttachmentsForExport_Item/typens:item/typens:Invoice/typens:ExportedAttachments">			
				<ATTACHMENT>
					<xsl:for-each select="/typens:PaymentExport_v2Request/typens:Payment_PaymentAttachmentsForExport_Item/typens:item/typens:Invoice/typens:ExportedAttachments/typens:item">
						<item>
							<FILE_NAME>
			...
			<DOCUMENTTYPE>
				<xsl:value-of select="'PaymentExport_v2Request'"/>
			</DOCUMENTTYPE>
			<!--<IG-37299 : XSLT Improvements, Rearranging tags >-->
			...
			<HEADERDATA>
				...
				<INVOICE_IND>
					<xsl:value-of select="$v_Header/typens:InvoiceReconciliationForExport/typens:SAPInvoiceInd"/>
				</INVOICE_IND>
				<xsl:choose>
					...
					<xsl:when test="$v_fiindicator = 'TRUE' and 
						($v_Header/typens:InvoiceReconciliationForExport/typens:Invoice/typens:IsPriceAdjustmentInvoice = 'false' or 
						string-length(normalize-space($v_Header/typens:InvoiceReconciliationForExport/typens:Invoice/typens:IsPriceAdjustmentInvoice)) = 0)"><!--<IG-37299 : XSLT Improvements >-->	
						<DOC_TYPE>
							<xsl:call-template name="FillDocType">
								<xsl:with-param name="p_doctype" select="$anSourceDocumentType"/>
				...
				<DOC_DATE>
					<xsl:variable name="v_doc_date" select="$v_Header/typens:InvoiceReconciliationForExport/typens:InvoiceDate"/>
					<xsl:if test="string-length(normalize-space($v_doc_date)) > 0"> <!--<IG-37299 : XSLT Improvements >-->
						<xsl:choose>
				...
				<REF_DOC_NO>
					<xsl:value-of select="upper-case($v_Header/typens:InvoiceReconciliationForExport/typens:Invoice/typens:InvoiceNumber)"/>
				</REF_DOC_NO>
				<COMP_CODE>
					<xsl:value-of select="$v_Header/typens:InvoiceReconciliationForExport/typens:CompanyCode/typens:UniqueName"/>
				</COMP_CODE>
				<DIFF_INV>
				...
				<GROSS_AMOUNT>
					...
					<xsl:choose>
						<xsl:when test="$v_Header/typens:InvoiceReconciliationForExport/typens:AdjustedTotalCostInERPPrecision/typens:Amount != ''">
							<xsl:choose>
								<xsl:when test="starts-with(string($v_Header/typens:InvoiceReconciliationForExport/typens:AdjustedTotalCostInERPPrecision/typens:Amount), '-')">
									<xsl:value-of select="format-number(($v_Header/typens:InvoiceReconciliationForExport/typens:AdjustedTotalCostInERPPrecision/typens:Amount * -1.00) + $v_TotalWithholdingTaxAmmount, '0.00')"/>					
								</xsl:when>
								<xsl:otherwise>
									<xsl:value-of select="format-number($v_Header/typens:InvoiceReconciliationForExport/typens:AdjustedTotalCostInERPPrecision/typens:Amount + $v_TotalWithholdingTaxAmmount, '0.00')"/>
								</xsl:otherwise>
							</xsl:choose>
						</xsl:when>
						<xsl:otherwise>
				...
				<BLINE_DATE>
					<xsl:variable name="v_bline_date" select="$v_Header/typens:InvoiceReconciliationForExport/typens:BaselineDateString"/>
				...
				<ITEM_TEXT>
					<xsl:choose>
						<xsl:when test="string-length(normalize-space($v_Header/typens:InvoiceReconciliationForExport/typens:UniqueName)) > 50"> <!--<IG-37299 : XSLT Improvements >-->
							<xsl:value-of select="substring($v_Header/typens:InvoiceReconciliationForExport/typens:UniqueName, 1, 50)"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="substring($v_Header/typens:InvoiceReconciliationForExport/typens:UniqueName, 1, 50)"/> <!--IG-39684 : Payment Request ITEM_TEXT not Truncating to 50 Char-->
						</xsl:otherwise>
					</xsl:choose>
				</ITEM_TEXT>
			...
			<PARTITION>
				<xsl:value-of select="typens:PaymentExport_v2Request/@partition"/>
			</PARTITION>
			<VARIANT>
				<xsl:value-of select="typens:PaymentExport_v2Request/@variant"/>
			</VARIANT>		
			<!-- Accounting Data-->
			<ACCOUNTINGDATA>
				...
				<xsl:for-each select="$v_GlAcc">
					<xsl:choose>
						...
						<xsl:when test="($v_fiindicator = 'TRUE')">
							...
							<xsl:if test="(../../../typens:LineType/typens:Category = '1' or ../../../typens:LineType/typens:Category = '0' or ../../../typens:LineType/typens:Category = '4' or ../../../typens:LineType/typens:Category = '8' or ../../../typens:LineType/typens:Category = '16' or string-length(normalize-space(../../../typens:LineType/typens:Category)) = 0)"> <!--<IG-37299 : XSLT Improvements >-->
					...
					<xsl:choose>
						...
						<xsl:when test="$v_NoPoNumber = boolean('true') and (../../../typens:LineType/typens:Category = '1' or string-length(normalize-space(../../../typens:LineType/typens:Category)) = 0 )"> <!--<IG-37299 : XSLT Improvements >-->
							<!--Call Template for GL Account Lines-->
							<xsl:call-template name="GlAccountDataTempletIn"/>
						</xsl:when>
				...
				<xsl:for-each select="$v_ItemData">
					<xsl:if test="typens:LineType/typens:Category = '1' and typens:ERPPONumber != ''">
						<item>
							...
							<PO_ITEM>
								<xsl:choose>
									<xsl:when test="string-length(normalize-space(typens:MatchedServiceSheetItem/typens:Receipt/typens:ERPServiceSheetID)) > 0"> <!--<IG-37299 : XSLT Improvements >-->
									...
									<xsl:when test="exists(typens:OrderLineItem/typens:SAPPOLineNumber) 
										and string-length(normalize-space(typens:OrderLineItem/typens:SAPPOLineNumber)) > 0"> <!--<IG-37299 : XSLT Improvements >-->
										<xsl:value-of select="typens:OrderLineItem/typens:SAPPOLineNumber"/>
									</xsl:when>
									<xsl:otherwise>
							...
							<xsl:variable name="v_matchedqty">
								<xsl:value-of select="$v_matchedReceipt[typens:LineNumber = $v_NumberInCollection]/typens:MatchedReceiptItems/typens:item/typens:Quantity"/>
							</xsl:variable>
							<xsl:variable name="v_ItemQty">
								<!--Remove negative value-->
								<xsl:choose>
									<xsl:when test="((typens:OrderLineItem/typens:ERSAllowed = 'true' and not(typens:MatchedServiceSheetItem/typens:Receipt/typens:ERPServiceSheetID))
										or (typens:GRBasedInvoice = 'true' and not(typens:MatchedServiceSheetItem/typens:Receipt/typens:ERPServiceSheetID)))">
										<xsl:choose>
											<xsl:when test="starts-with(string($v_matchedqty), '-')">
												<xsl:value-of select="$v_matchedqty* -1.000"/>					
											</xsl:when>
											<xsl:otherwise>
												<xsl:value-of select="$v_matchedqty"/>
											</xsl:otherwise>
										</xsl:choose>
									</xsl:when>
									<xsl:otherwise>
							...
							<ITEM_TEXT>
								<xsl:choose>
									<xsl:when test="string-length(normalize-space(typens:Description/typens:Description)) > 50"> <!--<IG-37299 : XSLT Improvements >-->
							...
							<!--<CI-1014 - GR-based Invoice Verification in P2P (SAP Ariba Buying and Invoicing)-->
								...
								<xsl:choose>
									<xsl:when test="string-length(normalize-space($v_erpReceiptDate)) > 8"> <!--<IG-37299 : XSLT Improvements >-->
										<REF_DOC_DATE>
	...
	<xsl:template name="GlAccountDataTempletIn">
		<item>
			...
			<ITEM_AMOUNT>
				<xsl:choose>
					<!-- Including LineType Category 4,8,16 to consider for Discount -->
					<xsl:when test="$DiscountDetails/Item[@NumberInCollection = $v_NewNumberInCollection]and (../../../typens:LineType/typens:Category = '1' or ../../../typens:LineType/typens:Category = '4' or ../../../typens:LineType/typens:Category = '8' or ../../../typens:LineType/typens:Category = '16' or string-length(normalize-space(../../../typens:LineType/typens:Category)) = 0) "> <!--<IG-37299 : XSLT Improvements >-->
						<!-- Discount-->
	...
	<xsl:template name="ValidatePriceChangeType">
		...
		<xsl:when
			...
			<!--Assign SAP Document type for subsequent debit document.-->
				<xsl:when
					test="$v_Header/typens:InvoiceReconciliationForExport/typens:Invoice/typens:InvoicePurpose = 'lineLevelDebitMemo'">
							<xsl:value-of select="'SDB'"/>								
				</xsl:when>
			<!--Assign SAP Document type for subsequent credit memo document-->
				<xsl:when
					test="$v_Header/typens:InvoiceReconciliationForExport/typens:Invoice/typens:InvoicePurpose = 'lineLevelCreditMemo'">
