...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="n0:ERPRespToAribaBuyerMsg">
        <urn:ReceiptAsyncImportPullRequest>
            ...
            <xsl:choose>
                <xsl:when test="LogMessage">
                    <urn:ReceiptError_ReceiptErrorImport_Item>
                ...
                <xsl:otherwise>
                    <urn:Receipt_ReceiptNumberImport_Item>
                        <urn:item>
