...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="n0:ERPRespToAribaBuyerMsg">
        <urn:CancelAdvancePaymentAsyncImportRequest>
            ...
            <xsl:choose>
                <xsl:when test="LogMessage">
                    <urn:AdvancePaymentError_AdvancePaymentCancelErrorImport_Item>
                ...
                <xsl:otherwise>
                    <urn:AdvancePayment_CancelAdvancePaymentIDImport_Item>
                        <urn:item>
