            ...
            <Delivery>
                ...
                <xsl:for-each
                    ...
                    <Party>
                        ...
                        <!-- Start of IG-29876 : Correction in reading street from postal address--> 
                        <xsl:variable name="v_street">
                            <xsl:value-of select="substring(PostalAddress/Street, 1, 60)"/>
                        </xsl:variable>
                        <!-- End of IG-29876 : Correction in reading street from postal address-->                         
