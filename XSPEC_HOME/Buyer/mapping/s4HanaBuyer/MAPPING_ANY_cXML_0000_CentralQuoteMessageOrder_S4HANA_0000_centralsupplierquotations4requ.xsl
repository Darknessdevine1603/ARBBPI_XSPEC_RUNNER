...
<xsl:stylesheet version="2.0"
    ...
    xmlns:n1="http://sap.com/xi/Procurement" 
    xmlns:xop="http://www.w3.org/2004/08/xop/include" exclude-result-prefixes="#all">
    ...
    <xsl:template match="Combined">
        <n1:CentralSupplierQuotationS4Request>
            <MessageHeader>
            ...
            <CentralSupplierQuotationS4>
                <xsl:call-template name="Fill_Proxy_QuoteMessageHeader">
                    <xsl:with-param name="p_QuoteMessage_header" select=" Payload/cXML/Message/QuoteMessage/QuoteMessageHeader"/>
                </xsl:call-template>
                ...
                <xsl:for-each select="Payload/cXML/Message/QuoteMessage/QuoteItemIn">
                    <SupplierQuotationItem>
                        <xsl:call-template name="Fill_QuoteMessage_Item">   
                            ...
                            <xsl:with-param name="p_QuoteMessage_header" select="//QuoteMessageHeader"/>
                        </xsl:call-template>
                    </SupplierQuotationItem>
                </xsl:for-each>
            </CentralSupplierQuotationS4>
