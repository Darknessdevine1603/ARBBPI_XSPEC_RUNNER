            ...
            <Request>
                ...
                <QuoteRequestHeader>
                    <xsl:call-template name="Fill_cXML_QuoteRequestHeader">
                        <xsl:with-param name="p_Quotation_header" select="//CentralRequestForQuotation"/>
                        <xsl:with-param name="p_message" select="/CentralRequestForQuotationS4Request"/>
                        <xsl:with-param name="p_indicator" select="'true'"/>
                    </xsl:call-template>
                </QuoteRequestHeader>
                    ...
                    <QuoteItemOut>
                        <xsl:call-template name="Fill_cXML_QuoteRequestItem">
                            ...
                            <xsl:with-param name="p_Quotation_address" select="CentralRFQItmDistribution/DeliveryAddress"/>
                        </xsl:call-template>  
                    </QuoteItemOut>
                </xsl:for-each>
                </QuoteRequest>
