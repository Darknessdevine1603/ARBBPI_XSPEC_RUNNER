                ...
                <F01_2014>
                    ...
                    <OBJECT_CONTRACT>
                        ...
                        <xsl:if
                            ...
                            <NO_LOT_DIVISION/>
<!--                            Added OBJECT_DESCR linked to NO_LOT_DIVISION - 37209-->
                            <OBJECT_DESCR>
                                <xsl:attribute name="ITEM">
                    ...
                    <xsl:if
                        test="string-length(normalize-space(section[externalId = 'LEFTI']/section/field[externalId = 'SUITABILITY']/value)) > 0">
                        <LEFTI>
                            <xsl:if
