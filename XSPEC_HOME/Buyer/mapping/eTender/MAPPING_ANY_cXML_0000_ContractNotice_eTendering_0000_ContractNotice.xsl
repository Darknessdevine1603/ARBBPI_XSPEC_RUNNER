            ...
            <FORM_SECTION>
                <F02_2014>
                    ...
                    <OBJECT_CONTRACT>
                        ...
                        <!--IG-41615 Begin-->
                        <!--Corrected the XPath to pick only the OBJECT_CONTRACT related Short decription-->
                        <SHORT_DESCR>
                            <xsl:call-template name="text_line">
                                <xsl:with-param name="p_path"
                        ...
                        <!--Corrected the XPath to pick only the OBJECT_CONTRACT related Estimated total value-->
                        <xsl:if
                                ...
                                <xsl:if test="
                                    ...
                                    <AC>
                                        ...
                                        <xsl:if test="
                                            ...
                                            <!--<AC_PROCUREMENT_DOC>
                                                <xsl:value-of
                                                  select="section[externalId = 'AC']/field[externalId = 'AC_PROCUREMENT_DOC']/value"
                                                />
                                            </AC_PROCUREMENT_DOC>-->
                                            <!--Element 'AC_PROCUREMENT_DOC' must have no character or element information item [children], 
                    ...
                    <PROCEDURE>
                        ...
                        <!--IG-39749 End-->
                        <xsl:if
                            test="exists(section[externalId = 'PROCEDURE']/section/field[externalId = 'ACCELERATED_PROC']/value[1])">
                            <ACCELERATED_PROC>
                                <xsl:call-template name="text_line">
                                    <xsl:with-param name="p_path"
                    ...
                    <COMPLEMENTARY_INFO>
                        ...
                        <xsl:if
                            test="exists(section[externalId = 'COMPLEMENTARY_INFO']/section/field[externalId = 'INFO_ADD']/value[1])">
                            <INFO_ADD>
                                <xsl:call-template name="text_line">
                                    <xsl:with-param name="p_path"
