                    ...
                    <urn:_bankMasterDetail>
                        <xsl:for-each select="E1BANK_CHANGE">
                            <urn:item>
                                ...
                                <urn:CheckDigitCalculationMethod>
                                    <xsl:value-of select="E1BP1011_DETAIL/METHOD"/>
                                </urn:CheckDigitCalculationMethod>
                                <urn:Format>
                                    <xsl:value-of select="E1BP1011_DETAIL/FORMATTING"/>
                                </urn:Format>
                            </urn:item>
                        </xsl:for-each>
                    </urn:_bankMasterDetail>
