...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}stylesheet-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/Users/i320581/Documents/XSPEC_HOME/Buyer/mapping/anSupplier/MAPPING_ANY_AddOn_0000_StatusUpdateRequest_cXML_0000_StatusUpdateRequest.xsl</xsl:variable>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}xspec-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/mapping/anSupplier/MAPPING_ANY_AddOn_0000_StatusUpdateRequest_cXML_0000_StatusUpdateRequest.xspec</xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}main"
      ...
      <xsl:result-document format="Q{{http://www.jenitennison.com/xslt/xspec}}xml-report-serialization-parameters">
         <xsl:element name="report" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:attribute name="xspec" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/mapping/anSupplier/MAPPING_ANY_AddOn_0000_StatusUpdateRequest_cXML_0000_StatusUpdateRequest.xspec</xsl:attribute>
            <xsl:attribute name="stylesheet" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/Buyer/mapping/anSupplier/MAPPING_ANY_AddOn_0000_StatusUpdateRequest_cXML_0000_StatusUpdateRequest.xsl</xsl:attribute>
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:element name="input-wrap" namespace="">
            <xsl:element name="x:context" namespace="http://www.jenitennison.com/xslt/xspec">
               <xsl:attribute name="href" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/anSupplier/StatusUpdate/StatusUpdateRequest.xml</xsl:attribute>
            </xsl:element>
         </xsl:element>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d55e0-doc"
                       as="document-node()"
                       select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/anSupplier/StatusUpdate/StatusUpdateRequest.xml')"/>
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:variable name="Q{urn:x-xspec:compile:impl}transform-options"
               ...
               <xsl:map>
                  ...
                  <xsl:map-entry key="'stylesheet-location'">file:/Users/i320581/Documents/XSPEC_HOME/Buyer/mapping/anSupplier/MAPPING_ANY_AddOn_0000_StatusUpdateRequest_cXML_0000_StatusUpdateRequest.xsl</xsl:map-entry>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d53e15-doc"
                    as="document-node()"
                    select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/target/outbound/anSupplier/StatusUpdate/StatusUpdateRequest.dat')"/>
      <xsl:variable xmlns:x="http://www.jenitennison.com/xslt/xspec"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:element name="input-wrap" namespace="">
            <xsl:element name="x:context" namespace="http://www.jenitennison.com/xslt/xspec">
               <xsl:attribute name="href" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/anSupplier/StatusUpdate/StatusUpdateRequestAccepted.xml</xsl:attribute>
            </xsl:element>
         </xsl:element>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d71e0-doc"
                       as="document-node()"
                       select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/anSupplier/StatusUpdate/StatusUpdateRequestAccepted.xml')"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d53e29-doc"
                    as="document-node()"
                    select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/target/outbound/anSupplier/StatusUpdate/StatusUpdateRequestAccepted.dat')"/>
      <xsl:variable xmlns:x="http://www.jenitennison.com/xslt/xspec"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario3"
      ...
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:element name="input-wrap" namespace="">
            <xsl:element name="x:context" namespace="http://www.jenitennison.com/xslt/xspec">
               <xsl:attribute name="href" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/anSupplier/StatusUpdate/StatusUpdateRequestRejected.xml</xsl:attribute>
            </xsl:element>
         </xsl:element>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d87e0-doc"
                       as="document-node()"
                       select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/anSupplier/StatusUpdate/StatusUpdateRequestRejected.xml')"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario3-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d53e43-doc"
                    as="document-node()"
                    select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/target/outbound/anSupplier/StatusUpdate/StatusUpdateRequestRejected.dat')"/>
      <xsl:variable xmlns:x="http://www.jenitennison.com/xslt/xspec"
