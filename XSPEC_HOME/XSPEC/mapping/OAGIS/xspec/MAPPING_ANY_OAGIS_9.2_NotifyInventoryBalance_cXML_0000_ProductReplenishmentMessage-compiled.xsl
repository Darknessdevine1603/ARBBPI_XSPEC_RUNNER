...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}stylesheet-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/Users/i320581/Documents/XSPEC_HOME/Supplier/mapping/OAGIS/MAPPING_ANY_OAGIS_9.2_NotifyInventoryBalance_cXML_0000_ProductReplenishmentMessage.xsl</xsl:variable>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}xspec-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/mapping/OAGIS/MAPPING_ANY_OAGIS_9.2_NotifyInventoryBalance_cXML_0000_ProductReplenishmentMessage.xspec</xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}main"
      ...
      <xsl:result-document format="Q{{http://www.jenitennison.com/xslt/xspec}}xml-report-serialization-parameters">
         <xsl:element name="report" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:attribute name="xspec" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/mapping/OAGIS/MAPPING_ANY_OAGIS_9.2_NotifyInventoryBalance_cXML_0000_ProductReplenishmentMessage.xspec</xsl:attribute>
            <xsl:attribute name="stylesheet" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/Supplier/mapping/OAGIS/MAPPING_ANY_OAGIS_9.2_NotifyInventoryBalance_cXML_0000_ProductReplenishmentMessage.xsl</xsl:attribute>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:context-item use="absent"/>
      <xsl:message>Notify Inventory Balance Product Replenishment Message</xsl:message>
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         <xsl:attribute name="id" namespace="">scenario1</xsl:attribute>
         <xsl:attribute name="xspec" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/mapping/OAGIS/MAPPING_ANY_OAGIS_9.2_NotifyInventoryBalance_cXML_0000_ProductReplenishmentMessage.xspec</xsl:attribute>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>Notify Inventory Balance Product Replenishment Message</xsl:text>
         </xsl:element>
         ...
         <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d52e10-doc" as="document-node()">
            <xsl:document>
               <xsl:text>ABCDEFGHIJKLMNOPQRSTUVWXYZ</xsl:text>
            </xsl:document>
         </xsl:variable>
         <xsl:variable name="Q{}upperAlpha"
                       select="$Q{urn:x-xspec:compile:impl}param-d52e10-doc ! ( node() )"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d52e12-doc" as="document-node()">
            <xsl:document>
               <xsl:text>abcdefghijklmnopqrstuvwxyz</xsl:text>
            </xsl:document>
         </xsl:variable>
         <xsl:variable name="Q{}lowerAlpha"
                       select="$Q{urn:x-xspec:compile:impl}param-d52e12-doc ! ( node() )"/>
         ...
         <xsl:element name="input-wrap" namespace="">
            <xsl:element name="x:context" namespace="http://www.jenitennison.com/xslt/xspec">
               <xsl:attribute name="href" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/OAGIS/ProductReplenishment/ProductReplenishmentNotifyInventory_BM.xml</xsl:attribute>
            </xsl:element>
         </xsl:element>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d54e0-doc"
                       as="document-node()"
                       select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/OAGIS/ProductReplenishment/ProductReplenishmentNotifyInventory_BM.xml')"/>
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:variable name="Q{urn:x-xspec:compile:impl}transform-options"
               ...
               <xsl:map>
                  ...
                  <xsl:map-entry key="'stylesheet-location'">file:/Users/i320581/Documents/XSPEC_HOME/Supplier/mapping/OAGIS/MAPPING_ANY_OAGIS_9.2_NotifyInventoryBalance_cXML_0000_ProductReplenishmentMessage.xsl</xsl:map-entry>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:message>Notify Inventory Balance Product Replenishment Message</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d52e19-doc"
                    as="document-node()"
                    select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/target/outbound/OAGIS/ProductReplenishment/ProductReplenishmentNotifyInventory_AM.dat')"/>
      <xsl:variable xmlns:x="http://www.jenitennison.com/xslt/xspec"
                    name="Q{urn:x-xspec:compile:impl}expect-d52e19"
                    select="$Q{urn:x-xspec:compile:impl}expect-d52e19-doc ! ( element() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d52e19, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2"
                 as="element(Q{http://www.jenitennison.com/xslt/xspec}scenario)">
      <xsl:context-item use="absent"/>
      <xsl:message>Notify Inventory Balance Product Replenishment Message - Prod</xsl:message>
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         <xsl:attribute name="id" namespace="">scenario2</xsl:attribute>
         <xsl:attribute name="xspec" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/mapping/OAGIS/MAPPING_ANY_OAGIS_9.2_NotifyInventoryBalance_cXML_0000_ProductReplenishmentMessage.xspec</xsl:attribute>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>Notify Inventory Balance Product Replenishment Message - Prod</xsl:text>
         </xsl:element>
         <xsl:variable name="Q{}output" select="()"/>
         <xsl:variable xmlns:x="http://www.jenitennison.com/xslt/xspec"
                       name="Q{}anSupplierANID"
         ...
         <xsl:variable xmlns:x="http://www.jenitennison.com/xslt/xspec"
                       name="Q{}anEnvName"
                       select="'PROD'"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d52e28-doc" as="document-node()">
            <xsl:document>
               <xsl:text>ABCDEFGHIJKLMNOPQRSTUVWXYZ</xsl:text>
            </xsl:document>
         </xsl:variable>
         <xsl:variable name="Q{}upperAlpha"
                       select="$Q{urn:x-xspec:compile:impl}param-d52e28-doc ! ( node() )"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d52e30-doc" as="document-node()">
            <xsl:document>
               <xsl:text>abcdefghijklmnopqrstuvwxyz</xsl:text>
            </xsl:document>
         </xsl:variable>
         <xsl:variable name="Q{}lowerAlpha"
                       select="$Q{urn:x-xspec:compile:impl}param-d52e30-doc ! ( node() )"/>
         <xsl:variable name="Q{}cXMLAttachments" select="()"/>
         <xsl:variable name="Q{}anSenderDefaultTimeZone" select="()"/>
         <xsl:variable xmlns:x="http://www.jenitennison.com/xslt/xspec"
                       name="Q{}attachSeparator"
         ...
         <xsl:element name="input-wrap" namespace="">
            <xsl:element name="x:context" namespace="http://www.jenitennison.com/xslt/xspec">
               <xsl:attribute name="href" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/OAGIS/ProductReplenishment/ProductReplenishmentNotifyInventoryProd_BM.xml</xsl:attribute>
            </xsl:element>
         </xsl:element>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d70e0-doc"
                       as="document-node()"
                       select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/OAGIS/ProductReplenishment/ProductReplenishmentNotifyInventoryProd_BM.xml')"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario2-expect1"
      ...
      <xsl:param name="Q{}attachSeparator" as="item()*" required="yes"/>
      <xsl:message>Notify Inventory Balance Product Replenishment Message - Prod</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d52e37-doc"
                    as="document-node()"
                    select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/target/outbound/OAGIS/ProductReplenishment/ProductReplenishmentNotifyInventoryProd_AM.dat')"/>
      <xsl:variable xmlns:x="http://www.jenitennison.com/xslt/xspec"
                    name="Q{urn:x-xspec:compile:impl}expect-d52e37"
                    select="$Q{urn:x-xspec:compile:impl}expect-d52e37-doc ! ( element() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d52e37, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
         <xsl:message>      FAILED</xsl:message>
      </xsl:if>
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d52e37"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
