...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}stylesheet-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/Users/i320581/Documents/XSPEC_HOME/Supplier/mapping/X12/MAPPING_ANY_ASC-X12_004010_832_cXML_0000_ProductCatalog.xsl</xsl:variable>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}xspec-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/mapping/X12/MAPPING_ANY_ASC-X12_004010_832_cXML_0000_ProductCatalog.xspec</xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}main"
      ...
      <xsl:result-document format="Q{{http://www.jenitennison.com/xslt/xspec}}xml-report-serialization-parameters">
         <xsl:element name="report" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:attribute name="xspec" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/mapping/X12/MAPPING_ANY_ASC-X12_004010_832_cXML_0000_ProductCatalog.xspec</xsl:attribute>
            <xsl:attribute name="stylesheet" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/Supplier/mapping/X12/MAPPING_ANY_ASC-X12_004010_832_cXML_0000_ProductCatalog.xsl</xsl:attribute>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:context-item use="absent"/>
      <xsl:message>Product Catalog Request</xsl:message>
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         <xsl:attribute name="id" namespace="">scenario1</xsl:attribute>
         <xsl:attribute name="xspec" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/mapping/X12/MAPPING_ANY_ASC-X12_004010_832_cXML_0000_ProductCatalog.xspec</xsl:attribute>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>Product Catalog Request</xsl:text>
         </xsl:element>
         <xsl:variable name="Q{}output" select="()"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d51e5-doc" as="document-node()">
            <xsl:document>
               <xsl:text>ABCDEFGHIJKLMNOPQRSTUVWXYZ</xsl:text>
            </xsl:document>
         </xsl:variable>
         <xsl:variable name="Q{}upperAlpha"
                       select="$Q{urn:x-xspec:compile:impl}param-d51e5-doc ! ( node() )"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}param-d51e7-doc" as="document-node()">
            <xsl:document>
               <xsl:text>abcdefghijklmnopqrstuvwxyz</xsl:text>
            </xsl:document>
         </xsl:variable>
         <xsl:variable name="Q{}lowerAlpha"
                       select="$Q{urn:x-xspec:compile:impl}param-d51e7-doc ! ( node() )"/>
         ...
         <xsl:element name="input-wrap" namespace="">
            <xsl:element name="x:context" namespace="http://www.jenitennison.com/xslt/xspec">
               <xsl:attribute name="href" namespace="">file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/X12/ProductCatalog/ProductCatalog_BM.xml</xsl:attribute>
            </xsl:element>
         </xsl:element>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d53e0-doc"
                       as="document-node()"
                       select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/base/outbound/X12/ProductCatalog/ProductCatalog_BM.xml')"/>
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:variable name="Q{urn:x-xspec:compile:impl}transform-options"
               ...
               <xsl:map>
                  ...
                  <xsl:map-entry key="'stylesheet-location'">file:/Users/i320581/Documents/XSPEC_HOME/Supplier/mapping/X12/MAPPING_ANY_ASC-X12_004010_832_cXML_0000_ProductCatalog.xsl</xsl:map-entry>
                  ...
                  <xsl:map-entry key="if ($Q{urn:x-xspec:compile:impl}context-d53e0 instance of node()) then 'source-node' else 'initial-match-selection'"
                                 select="$Q{urn:x-xspec:compile:impl}context-d53e0"/>
               </xsl:map>
            </xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:message>Product Catalog Request</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d51e18-doc"
                    as="document-node()"
                    select="doc('file:/Users/i320581/Documents/XSPEC_HOME/XSPEC/payloads/target/outbound/X12/ProductCatalog/ProductCatalog_AM.dat')"/>
      <xsl:variable xmlns:x="http://www.jenitennison.com/xslt/xspec"
                    name="Q{urn:x-xspec:compile:impl}expect-d51e18"
                    select="$Q{urn:x-xspec:compile:impl}expect-d51e18-doc ! ( element() )"><!--expected result--></xsl:variable>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
                    as="Q{http://www.w3.org/2001/XMLSchema}boolean"
                    select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d51e18, $Q{http://www.jenitennison.com/xslt/xspec}result, '')"/>
