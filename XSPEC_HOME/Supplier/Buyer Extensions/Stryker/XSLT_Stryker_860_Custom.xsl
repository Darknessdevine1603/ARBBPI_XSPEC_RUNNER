...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
  ...
  <xsl:template match="//M_860/G_N1[1]">
  ...
  <xsl:template match="//M_860/G_N1[S_N1/D_98 = 'FR']">
    <G_N1>
      <S_N1>
        <xsl:copy-of select="//M_860/G_N1/S_N1[D_98 = 'FR']/D_93/preceding-sibling::*"/>
        <xsl:choose>
          ...
          <xsl:otherwise>
            <xsl:copy-of select="//M_860/G_N1/S_N1[D_98 = 'FR']/D_93"/>
          </xsl:otherwise>
        </xsl:choose>
        <xsl:copy-of select="//M_860/G_N1/S_N1[D_98 = 'FR']/D_93/following-sibling::*"/>
      </S_N1>
      <xsl:copy-of select="//M_860/G_N1[S_N1/D_98 = 'FR']/S_N2"/>
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:copy-of select="//M_860/G_N1[S_N1/D_98 = 'FR']/S_N3"/>
        </xsl:otherwise>
      </xsl:choose>
      <xsl:variable name="tokenizedList1"
        select="tokenize(/Combined/source/cXML/Request/OrderRequest/OrderRequestHeader/Extrinsic[@name = 'addresseeReference'], ',')"/>
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:copy-of select="//M_860/G_N1[S_N1/D_98 = 'FR']/S_N4"/>
        </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="//M_860/G_N1[S_N1/D_98 = 'FR']/S_PER"/>
    </G_N1>
  </xsl:template>
  <xsl:template match="//M_860/G_POC/S_REF[last()]">
    <xsl:copy-of select="."/>
    <xsl:variable name="pos1" select="../S_POC/D_350"/>
    <xsl:if
