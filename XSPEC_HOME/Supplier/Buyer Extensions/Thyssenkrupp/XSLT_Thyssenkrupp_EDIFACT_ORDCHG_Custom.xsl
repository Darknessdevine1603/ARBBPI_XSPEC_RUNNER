...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
   ...
   <xsl:template match="//M_ORDCHG/S_FTX[D_4451 = 'ZZZ' and C_C108/D_4440 = 'incoTermDesc']">
      <xsl:choose>
   ...
   <xsl:template match="//M_ORDCHG/G_SG3[last()]">
      <xsl:copy-of select="."/>
   ...
   <xsl:template match="//M_ORDCHG/G_SG26">
      <G_SG26>
         ...
         <xsl:apply-templates select="G_SG27 | G_SG28 | G_SG29 | G_SG30 | G_SG31 | G_SG32 | G_SG35 | G_SG36 | G_SG37 | G_SG41 | G_SG47 | G_SG49 | G_SG50 | G_SG51 | G_SG53 | G_SG54"/>
      </G_SG26>
   </xsl:template>
   <xsl:template match="//M_ORDCHG/G_SG12">
      <G_SG12>
         <S_TOD>
