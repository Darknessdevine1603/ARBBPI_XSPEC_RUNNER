...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- Extension Start  -->
  <xsl:template match="//M_ORDERS/S_BGM">
    <S_BGM>
      <xsl:apply-templates select="C_C106 | C_C002 | D_1225"/>
      <xsl:choose>
  ...
  <xsl:template match="//M_ORDERS/S_FTX[D_4451 = 'SIN']">
    <xsl:choose>
  ...
  <xsl:template match="//M_ORDERS/G_SG28/S_FTX[D_4451 = 'ORI']"/>
  <xsl:template match="//M_ORDERS/G_SG28/S_IMD">
    <xsl:choose>
  ...
  <xsl:template match="//M_ORDERS/G_SG28/G_SG33/S_RFF/C_C506[D_1153 = 'ALQ']/D_1153">
    <D_1153>AKO</D_1153>
  </xsl:template>
  <xsl:template match="//M_ORDERS/G_SG28//S_FTX[D_4451 = 'SIN']"/>
  <xsl:template match="//M_ORDERS/G_SG2/S_NAD">
  ...
  <xsl:template match="//M_ORDERS/G_SG28/G_SG38/S_MOA[C_C516/D_5025 = '124']">
    <S_MOA>
      <C_C516>
        <D_5025>369</D_5025>
  ...
  <xsl:template match="//M_ORDERS/G_SG28/G_SG38[S_MOA/C_C516/D_5025 = '125']"/>
  <xsl:template match="//M_ORDERS/S_MOA[C_C516/D_5025 = '124']">
    <S_MOA>
      <C_C516>
        <D_5025>369</D_5025>
        <xsl:copy-of select="C_C516/D_5025/following-sibling::*"/>
