...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//M_850/S_REF[D_127 = 'ultimateCustomerReferenceID']">
		<xsl:if
	...
	<xsl:template match="//M_850/S_REF[D_127 = 'customerReferenceID']">
		<xsl:if
	...
	<xsl:template match="//M_850/S_REF[D_127 = 'additionalReferenceID']">
		<xsl:if
	...
	<xsl:template match="//M_850/S_FOB">
		<S_FOB>
	...
	<xsl:template match="//M_850/G_N1[S_N1/D_98 = 'ZZ']">
		<xsl:choose>
			<xsl:when
	...
	<xsl:template match="//M_850/G_PO1/S_DTM[last()]">
