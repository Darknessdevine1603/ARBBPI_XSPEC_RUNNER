...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
   ...
   <xsl:template match="//M_860/S_DTM[D_374='177']">
      <S_DTM>
         <D_374>
	...
	<xsl:template match="//M_860/G_POC/S_REF[D_128='ZZ' and lower-case(D_127)='customerspartno']">
		<xsl:element name="S_REF">
	...
	<xsl:template match="//M_860/G_POC/S_REF[D_128='ZZ' and lower-case(D_127)='customsbarcodenumber']">
		<xsl:element name="S_REF">
