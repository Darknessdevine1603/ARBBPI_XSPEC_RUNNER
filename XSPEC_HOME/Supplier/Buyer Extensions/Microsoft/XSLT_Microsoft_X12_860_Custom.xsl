...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
	...
	<!-- Extension Start  -->
	<xsl:template match="//M_860/S_REF[D_127 = 'CompanyCode']">
	...
	<xsl:template match="//M_860/S_ITD">
		<S_ITD>
	...
	<xsl:template match="//M_860/G_N1">
		<xsl:variable name="currentN1POS" select="count(./preceding-sibling::*) + 1"/>
		<xsl:variable name="firstN1POS" select="count(//M_860/G_N1[1]/preceding-sibling::*) + 1"/>
	...
	<xsl:template match="//M_860/G_POC">
		<G_POC>
			<xsl:variable name="pos1" select="S_POC/D_350"/>
			<xsl:copy-of select="S_POC"/>
			...
			<xsl:copy-of select="S_POC/following-sibling::* intersect S_REF[1]/preceding-sibling::*"/>
			...
			<xsl:if test="//cXML/Request/OrderRequest/ItemOut[@lineNumber = $pos1]/ItemOutIndustry/ReferenceDocumentInfo/Extrinsic[@name = 'salesCurrency'] != ''">
				<S_REF>
					...
					<D_352>
						<xsl:value-of select="//cXML/Request/OrderRequest/ItemOut[@lineNumber = $pos1]/ItemOutIndustry/ReferenceDocumentInfo/Extrinsic[@name = 'salesCurrency']"/>
					</D_352>
