         ...
         <FunctionalGroup>
            ...
            <M_850>
               ...
               <S_BEG>
                  ...
                  <xsl:if test="cXML/Request/OrderRequest/OrderRequestHeader/@releaseRequired != ''">
                     <D_328>
                        <xsl:value-of select="cXML/Request/OrderRequest/OrderRequestHeader/@releaseRequired"/>
                     </D_328>
                  </xsl:if>
                  <D_373>
               ...
               <S_CUR>
                  ...
                  <xsl:if test="cXML/Request/OrderRequest/OrderRequestHeader/Total/Money/@alternateAmount != ''">
                     <D_280>
                        ...
                        <!--xsl:value-of select="replace(cXML/Request/OrderRequest/OrderRequestHeader/Total/Money/@alternateAmount,',','')"/-->
                     </D_280>
                  </xsl:if>
               ...
               <!-- No need to send payloadID						xsl:call-template name="payloadID">						<xsl:with-param name="PayloadID" select="cXML/@payloadID"/>					</xsl:call-template-->
                  ...
                  <G_SAC>
                     <S_SAC>
                        ...
                        <D_610>
                           ...
                           <!-- N2 number needs to have two decimals -->
                        </D_610>
               ...
               <xsl:if test="cXML/Request/OrderRequest/OrderRequestHeader/Tax/Money != ''">
                  <S_TXI>
                     ...
                     <D_782>
                        ...
                        <!--xsl:value-of select="replace(cXML/Request/OrderRequest/OrderRequestHeader/Tax/Money,',','')"/-->
                        <!-- CG Money updated -->
                     </D_782>
                  </S_TXI>
               </xsl:if>
               ...
               <xsl:for-each select="cXML/Request/OrderRequest/ItemOut">
                  <xsl:variable name="uom">
                  	<xsl:choose>
                  		...
                  		<xsl:when test="normalize-space(BlanketItemDetail/UnitOfMeasure) != ''">
                  			<xsl:value-of select="normalize-space(BlanketItemDetail/UnitOfMeasure)"/>
                  		</xsl:when>
                  ...
                  <G_PO1>
                              ...
                              <D_380>
                                 <xsl:choose>
                                    ...
                                    <xsl:when test="BlanketItemDetail/PriceBasisQuantity/@quantity != ''">
                                       ...
                                       <!--xsl:value-of select="BlanketItemDetail/PriceBasisQuantity/@quantity"/-->
                                    </xsl:when>
                                 </xsl:choose>
                              </D_380>
                     ...
                     <xsl:if test="BlanketItemDetail/MaxAmount/Money != ''">
                        <G_CTP>
                           ...
                           <S_CUR>
                              <D_98>BY</D_98>
                              <D_100>
                                 <xsl:value-of select="BlanketItemDetail/MaxAmount/Money/@currency"/>
                              </D_100>
                              <xsl:if test="BlanketItemDetail/MaxAmount/Money/@alternateAmount != ''">
                                 <D_280>
                                    <xsl:call-template name="formatAmount">
                                       <xsl:with-param name="amount" select="BlanketItemDetail/MaxAmount/Money/@alternateAmount"/>
                                    </xsl:call-template>
                                    <!--xsl:value-of select="format-number(number(replace(BlanketItemDetail/MaxAmount/Money/@alternateAmount,',','')),'0000')"/-->
                                 </D_280>
                              </xsl:if>
                              <xsl:if test="BlanketItemDetail/MaxAmount/Money/@alternateCurrency != ''">
                                 <D_98_2>ZZ</D_98_2>
                                 <D_100_2>
                                    <xsl:value-of select="BlanketItemDetail/MaxAmount/Money/@alternateCurrency"/>
                                 </D_100_2>
                              </xsl:if>
                           </S_CUR>
                        </G_CTP>
                     ...
                     <xsl:if test="BlanketItemDetail/MinAmount/Money != ''">
                        <G_CTP>
                           ...
                           <S_CUR>
                              <D_98>BY</D_98>
                              <D_100>
                                 <xsl:value-of select="BlanketItemDetail/MinAmount/Money/@currency"/>
                              </D_100>
                              <xsl:if test="BlanketItemDetail/MinAmount/Money/@alternateAmount != ''">
                                 <D_280>
                                    <xsl:call-template name="formatAmount">
                                       <xsl:with-param name="amount" select="BlanketItemDetail/MinAmount/Money/@alternateAmount"/>
                                    </xsl:call-template>
                                    <!--xsl:value-of select="format-number(number(replace(BlanketItemDetail/MinAmount/Money/@alternateAmount,',','')),'0000')"/-->
                                 </D_280>
                              </xsl:if>
                              <xsl:if test="BlanketItemDetail/MinAmount/Money/@alternateCurrency != ''">
                                 <D_98_2>ZZ</D_98_2>
                                 <D_100_2>
                                    <xsl:value-of select="BlanketItemDetail/MinAmount/Money/@alternateCurrency"/>
                                 </D_100_2>
                              </xsl:if>
                           </S_CUR>
                        </G_CTP>
                     ...
                     <xsl:if test="BlanketItemDetail/UnitPrice/Money != ''">
                        <G_CTP>
                           <S_CTP>
                              ...
                              <D_212>
                                 <xsl:choose>
                                    <xsl:when test="BlanketItemDetail/Extrinsic[@name = 'hideUnitPrice']">0.00</xsl:when>
                                    <xsl:when test="/cXML/Request/OrderRequest/OrderRequestHeader/Extrinsic[@name = 'hideUnitPrice']">0.00</xsl:when>
                                    <xsl:otherwise>
                                       <xsl:call-template name="formatAmount">
                                          <xsl:with-param name="amount" select="BlanketItemDetail/UnitPrice/Money"/>
                           ...
                           <S_CUR>
                              ...
                              <xsl:if test="BlanketItemDetail/UnitPrice/Money/@alternateAmount != ''">
                                 <D_280>
                                    <xsl:call-template name="formatAmount">
                                       <xsl:with-param name="amount" select="BlanketItemDetail/UnitPrice/Money/@alternateAmount"/>
                                    </xsl:call-template>
                                    <!--xsl:value-of select="format-number(number(replace(BlanketItemDetail/UnitPrice/Money/@alternateAmount,',','')),'0000')"/-->
                                 </D_280>
                              </xsl:if>
                              <xsl:if test="BlanketItemDetail/UnitPrice/Money/@alternateCurrency != ''">
                                 <D_98_2>ZZ</D_98_2>
                                 <D_100_2>
                                    <xsl:value-of select="BlanketItemDetail/UnitPrice/Money/@alternateCurrency"/>
                                 </D_100_2>
                     ...
                     <xsl:for-each select="ScheduleLine">
                        <xsl:call-template name="createSCH_FromScheduleLine">
                           ...
                           <xsl:with-param name="mapREF" select="'true'"/>
                        </xsl:call-template>
                     </xsl:for-each>
                     <!-- Packaging -->
                           ...
                           <G_SLN>
                              <S_SLN>
                                 ...
                                 <D_380>
                                    ...
                                    <!-- IG-2106 fix for qty greater than 999-->
               ...
               <G_CTT>
                  ...
                  <S_AMT>
                     ...
                     <D_782>
                        <xsl:choose>
                           <xsl:when test="cXML/Request/OrderRequest/OrderRequestHeader/Extrinsic[@name = 'hideAmount']">0</xsl:when>
                           ...
                           <xsl:otherwise>
                              ...
                              <!--xsl:value-of select="format-number(number(replace(cXML/Request/OrderRequest/OrderRequestHeader/Total/Money,',','')),'0.##')"/-->
                           </xsl:otherwise>
                        </xsl:choose>
                     </D_782>
                  </S_AMT>
