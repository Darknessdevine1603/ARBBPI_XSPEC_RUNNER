...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <!--  <xsl:include href="FORMAT_cXML_0000_UN-EDIFACT_D96A.xsl"/>-->
   ...
   <xsl:template match="/">
      ...
      <ns0:Interchange xmlns:ns0="urn:sap.com:typesystem:b2b:6:un-edifact:ordchg:d.96a">
         <S_UNA>:+.? '</S_UNA>
         <S_UNB>
            <C_S001>
               <D_0001>UNOC</D_0001>
            ...
            <D_0026>ORDCHG</D_0026>
            <xsl:if test="upper-case($anEnvName) = 'TEST'">
               <D_0035>1</D_0035>
            </xsl:if>
         </S_UNB>
         <xsl:element name="M_ORDCHG">
            <S_UNH>
               <D_0062>0001</D_0062>
               <C_S009>
            ...
            <S_BGM>
               <C_C002>
                  ...
                  <D_1000>
                     <xsl:text>Purchase Order Change Request</xsl:text>
                  </D_1000>
               </C_C002>
               <D_1004>
                  <xsl:value-of
            ...
            <!-- OriginalId -->
            <xsl:if
               test="normalize-space(cXML/Request/OrderRequest/OrderRequestHeader/Extrinsic[@name = 'OriginalId']) != ''">
               <G_SG1>
                  <S_RFF>
                     <C_C506>
                        <D_1153>PW</D_1153>
                        <D_1154>
                           <xsl:value-of
                              select="substring(normalize-space(cXML/Request/OrderRequest/OrderRequestHeader/Extrinsic[@name = 'OriginalId']), 1, 35)"
                           />
                        </D_1154>
                     </C_C506>
                  </S_RFF>
            ...
            <!-- payloadID -->
            <!--                <xsl:if test="cXML/@payloadID !=''"><xsl:call-template name="mapPayloadID"><xsl:with-param name="payloadID" select="normalize-space(cXML/@payloadID)"/><xsl:with-param name="payloadQUAL" select="'IL'"/></xsl:call-template></xsl:if>                -->
            ...
            <G_SG8>
               <S_CUX>
                  <C_C504>
                     ...
                     <D_6345>
                        <xsl:value-of
                           select="normalize-space(cXML/Request/OrderRequest/OrderRequestHeader/Total/Money/@currency)"
                        />
                     </D_6345>
                     <D_6343>9</D_6343>
                  </C_C504>
                  <xsl:if
                     ...
                     <C_C504_2>
                        ...
                        <D_6345>
                           <xsl:value-of
                              select="normalize-space(cXML/Request/OrderRequest/OrderRequestHeader/Total/Money/@alternateCurrency)"
                           />
                        </D_6345>
                        <D_6343>7</D_6343>
                     </C_C504_2>
            ...
            <xsl:if
               ...
               <G_SG19>
                  ...
                  <xsl:call-template name="createMOA">
                     <xsl:with-param name="grpNum" select="'G_SG22'"/>
            ...
            <xsl:for-each select="cXML/Request/OrderRequest/ItemOut">
               <G_SG26>
                  ...
                  <xsl:if test="normalize-space(@subcontractingType) != ''">
                     <S_FTX>
                        ...
                        <C_C108>
                           ...
                           <D_4440_2>
                              <xsl:value-of
                                 select="substring(normalize-space(@subcontractingType), 1, 70)"/>
                           </D_4440_2>
                        </C_C108>
                     </S_FTX>
                  </xsl:if>
                  <xsl:if test="normalize-space(@itemCategory) != ''">
                     <S_FTX>
                        ...
                        <C_C108>
                           ...
                           <D_4440_2>
                              <xsl:value-of
                                 select="substring(normalize-space(@itemCategory), 1, 70)"/>
                           </D_4440_2>
                        </C_C108>
                     </S_FTX>
                  </xsl:if>
                  ...
                  <!-- IG-20205: added new loop SG32 PAC+0 for Batch in sync with addition for SubcontractingComponent, if itemout/batch exists-->
                  ...
                  <xsl:for-each select="Tax/TaxDetail[10 &gt;= position()]">
                     <G_SG36>
                        <S_TAX>
                           ...
                           <xsl:if
                              test="normalize-space(@isTriangularTransaction) = 'yes' or normalize-space(@percentageRate) != ''">
                              <C_C243>
                                 <xsl:if test="normalize-space(@isTriangularTransaction) = 'yes'">
                                    <D_5279>TT</D_5279>
                                 </xsl:if>
                                 <xsl:if test="normalize-space(@percentageRate) != ''">
                                    <D_5278>
                  ...
                  <xsl:if test="normalize-space(Shipping/Money) != ''">
                     <G_SG41>
                        ...
                        <xsl:call-template name="createMOA">
                           <xsl:with-param name="grpNum" select="'G_SG44'"/>
                           <xsl:with-param name="qual" select="'23'"/>
            ...
            <!--IG-20205-added new loop SG26 (LIN++:MP with 7083="A") for SubcontractingComponent-->
                  ...
                  <G_SG26>
                     ...
                     <xsl:if test="normalize-space(Description/ShortName) != ''">
                        <xsl:variable name="shortName">
                           ...
                           <xsl:value-of select="normalize-space(Description/ShortName)"/>
                        </xsl:variable>
                        <xsl:variable name="langCode">


                           <xsl:if test="normalize-space(Description/@xml:lang) != ''">
                              <xsl:value-of select="normalize-space(Description/@xml:lang)"/>
                           </xsl:if>
                        ...
                        <G_SG31>
                           <S_RFF>
                              <C_C506>
                                 ...
                                 <D_1154>
                                    <xsl:value-of
                                       select="normalize-space(@materialProvisionIndicator)"/>
                                 </D_1154>
                     ...
                     <!-- IG-20205: added new loop SG32 PAC+0 for Batch in sync with addition for SubcontractingComponent, if SubcontractingComponent/batch exists -->
                     <xsl:if test="exists(Batch)">
   ...
   <!-- IG-20205 ER - EDIFACT ORDCHG D96A Out - to add SubcontractingComponent for SCC-->
            ...
            <S_RFF>
               <C_C506>
                  ...
                  <xsl:if test="$path/Batch/@originCountryCode != ''">
                     <D_1154>
                        <xsl:value-of select="normalize-space($path/Batch/@originCountryCode)"/>
                     </D_1154>
                  </xsl:if>
