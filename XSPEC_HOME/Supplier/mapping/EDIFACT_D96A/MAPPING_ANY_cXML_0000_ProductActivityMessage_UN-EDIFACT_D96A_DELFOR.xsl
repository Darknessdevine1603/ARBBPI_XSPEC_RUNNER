        ...
        <ns0:Interchange xmlns:ns0="urn:sap.com:typesystem:b2b:6:un-edifact:delfor:d.96a">
            ...
            <xsl:element name="M_DELFOR">
                ...
                <S_BGM>
                    ...
                    <D_1004>
                        <xsl:value-of
                            select="normalize-space(substring(cXML/Message/ProductActivityMessage/ProductActivityHeader/@messageID, 1, 35))"
                        />
                    </D_1004>
                ...
                <!-- creation Date -->
                <xsl:if
                    test="normalize-space(cXML/Message/ProductActivityMessage/ProductActivityHeader/@creationDate) != ''">
                    <S_DTM>
                        <C_C507>
                            <D_2005>137</D_2005>
                            <xsl:call-template name="formatDate">
                                <xsl:with-param name="DocDate"
                                    select="normalize-space(cXML/Message/ProductActivityMessage/ProductActivityHeader/@creationDate)"
                                />
                            </xsl:call-template>
                        </C_C507>
                    </S_DTM>
                ...
                <xsl:if
                    test="normalize-space(cXML/Header/From/Credential[@domain = 'SystemID']/Identity) != ''">
                    <G_SG1>
                        <S_RFF>
                            <C_C506>
                                <D_1153>MS</D_1153>
                                <D_1154>
                                    <xsl:value-of
                                        select="substring(normalize-space(cXML/Header/From/Credential[@domain = 'SystemID']/Identity), 1, 35)"
                                    />
                                </D_1154>
                            </C_C506>
                        </S_RFF>
                ...
                <xsl:for-each select="cXML/Message/ProductActivityMessage/ProductActivityDetails">
                    <G_SG18>
                            ...
                            <xsl:choose>
                                <xsl:when test="normalize-space(ItemID/SupplierPartID) != ''">
                                    <xsl:call-template name="createItemParts">
                                        <xsl:with-param name="SupplierPartID"
                                            select="ItemID/SupplierPartID"/>
                                    </xsl:call-template>
                                </xsl:when>
                                <xsl:when
                                    test="normalize-space(ItemID/IdReference[@domain = 'EAN-13']/@identifier) != ''">
                                    <xsl:call-template name="createItemParts">
                                        <xsl:with-param name="IdReference"
                                            select="ItemID/IdReference[@domain = 'EAN-13']/@identifier"
                                        />
                                    </xsl:call-template>
                                </xsl:when>
                                <xsl:when test="normalize-space(ItemID/BuyerPartID) != ''">
                                    <xsl:call-template name="createItemParts">
                                        <xsl:with-param name="BuyerPartID"
                                            select="ItemID/BuyerPartID"/>
                                    </xsl:call-template>
                                </xsl:when>
                                <xsl:when test="normalize-space(ManufacturerPartID) != ''">
                                    <xsl:call-template name="createItemParts">
                                        <xsl:with-param name="ManufacturerPartID"
                                            select="ManufacturerPartID"/>
                                    </xsl:call-template>
                                </xsl:when>
                                <xsl:when
                                    test="normalize-space(ItemID/SupplierPartAuxiliaryID) != ''">
                                    <xsl:call-template name="createItemParts">
                                        <xsl:with-param name="SupplierPartAuxiliaryID"
                                            select="ItemID/SupplierPartAuxiliaryID"/>
                                    </xsl:call-template>
                                </xsl:when>

                                <xsl:when
                                    test="normalize-space(ItemID/IdReference[@domain = 'UPCUniversalProductCode']/@identifier) != ''">
                                    <xsl:call-template name="createItemParts">
                                        <xsl:with-param name="IdReference-UPCUniversalProductCode"
                                            select="ItemID/IdReference[@domain = 'UPCUniversalProductCode']/@identifier"
                                        />
                                    </xsl:call-template>
                                </xsl:when>
                                <xsl:when
                                    test="normalize-space(ItemID/IdReference[@domain = 'europeanWasteCatalogID']/@identifier) != ''">
                                    <xsl:call-template name="createItemParts">
                                        <xsl:with-param name="IdReference-europeanWasteCatalogID"
                                            select="ItemID/IdReference[@domain = 'europeanWasteCatalogID']/@identifier"
                                        />
                                    </xsl:call-template>
                                </xsl:when>
                                <xsl:when
                                    test="normalize-space(Classification[@domain = 'UNSPSC']) != ''">
                                    <xsl:call-template name="createItemParts">
                                        <xsl:with-param name="Classification"
                                            select="Classification[@domain = 'UNSPSC']"/>
                                    </xsl:call-template>
                                </xsl:when>
                            </xsl:choose>
                        ...
                        <xsl:if
                            test="normalize-space(ItemID/BuyerPartID) != '' or normalize-space(ManufacturerPartID) != '' or normalize-space(ItemID/SupplierPartAuxiliaryID) != ''">
                            <S_PIA>
                                <D_4347>5</D_4347>
                                <xsl:choose>
                                    <xsl:when test="normalize-space(ItemID/BuyerPartID) != ''">
                                        <xsl:call-template name="createItemParts">
                                            <xsl:with-param name="BuyerPartID"
                                                select="ItemID/BuyerPartID"/>
                                            <xsl:with-param name="ManufacturerPartID"
                                                select="normalize-space(ManufacturerPartID)"/>
                                            <xsl:with-param name="SupplierPartAuxiliaryID"
                                                select="ItemID/SupplierPartAuxiliaryID"/>
                                        </xsl:call-template>
                                    </xsl:when>
                        ...
                        <xsl:if
                            test="normalize-space(ItemID/IdReference[@domain = 'EAN-13']/@identifier) != '' or normalize-space(Classification[@domain = 'UNSPSC']) != '' or normalize-space(ItemID/IdReference[@domain = 'UPCUniversalProductCode']/@identifier) != '' or normalize-space(ItemID/IdReference[@domain = 'europeanWasteCatalogID']/@identifier) != ''">
                            <S_PIA>
                                <D_4347>1</D_4347>
                                <xsl:choose>
                                    <xsl:when
                                        ...
                                        <xsl:call-template name="createItemParts">
                                            ...
                                            <xsl:with-param name="Classification"
                                                select="Classification[@domain = 'UNSPSC']"/>
                                            <xsl:with-param
                                                name="IdReference-UPCUniversalProductCode"
                                                select="ItemID/IdReference[@domain = 'UPCUniversalProductCode']/@identifier"/>
                                            <xsl:with-param
                                                name="IdReference-europeanWasteCatalogID"
                                                select="ItemID/IdReference[@domain = 'europeanWasteCatalogID']/@identifier"
                                            />
                                        </xsl:call-template>
                                    </xsl:when>
                        ...
                        <!-- Characteristic -->
                        <xsl:variable name="charDomain"
                            select="normalize-space(Characteristic/@domain)"/>
                        <xsl:if
                        ...
                        <xsl:if test="normalize-space(PlannedAcceptanceDays) != ''">
                            <S_DTM>
                                <C_C507>
                                    ...
                                    <D_2380>
                                        <xsl:value-of
                                            select="normalize-space(PlannedAcceptanceDays)"/>
                                    </D_2380>
                                    <D_2379>804</D_2379>
                                </C_C507>
                            </S_DTM>
                            ...
                            <G_SG19>
                                <S_RFF>
                                    <C_C506>
                                        ...
                                        <D_1154>
                                            <xsl:value-of
                                                select="substring(normalize-space(@status), 1, 35)"
                                            />
                                        </D_1154>
                                    </C_C506>
                                </S_RFF>
                                ...
                                <G_SG20>
                                    <S_QTY>
                                        <C_C186>
                                            ...
                                            <D_6060>
                                                <xsl:value-of
                                                  select="format-number(ForecastQuantity/@quantity, '0.##')"
                                                />
                                            </D_6060>
                                            <xsl:if
                                                test="normalize-space(ForecastQuantity/UnitOfMeasure) != ''">
                                                <D_6411>
                                                  <xsl:value-of
                                                  select="substring(ForecastQuantity/UnitOfMeasure, 1, 3)"
                                                  />
                                                </D_6411>
                                            </xsl:if>
                                        </C_C186>
                                    ...
                                    <xsl:if test="normalize-space(Period/@startDate) != ''">
                                        <S_DTM>
                                            <C_C507>
                                                ...
                                                <xsl:call-template name="formatDate">
                                                  <xsl:with-param name="DocDate"
                                                  select="normalize-space(Period/@startDate)"/>
                                                </xsl:call-template>
                                            </C_C507>
                                        </S_DTM>
                                    </xsl:if>
                                    ...
                                    <xsl:if test="normalize-space(Period/@endDate) != ''">
                                        <S_DTM>
                                            <C_C507>
                                                ...
                                                <xsl:call-template name="formatDate">
                                                  <xsl:with-param name="DocDate"
                                                  select="normalize-space(Period/@endDate)"/>
                                                </xsl:call-template>
                                            </C_C507>
                                        </S_DTM>
                                    </xsl:if>
                                ...
                                <G_SG20>
                                    <S_QTY>
                                        <C_C186>
                                            ...
                                            <D_6060>
                                                <xsl:value-of
                                                  select="format-number(TimeSeriesQuantity/@quantity, '0.##')"
                                                />
                                            </D_6060>
                                            <xsl:if
                                                test="normalize-space(TimeSeriesQuantity/UnitOfMeasure) != ''">
                                                <D_6411>
                                                  <xsl:value-of
                                                  select="substring(TimeSeriesQuantity/UnitOfMeasure, 1, 3)"
                                                  />
                                                </D_6411>
                                            </xsl:if>
                                        </C_C186>
                        ...
                        <xsl:for-each select="InventoryTimeSeries/TimeSeriesDetails">
                            <xsl:if test="normalize-space(TimeSeriesQuantity/@quantity) != ''">
                                <G_SG20>
                                    ...
                                    <xsl:if
                                        test="../@type = 'grossdemand' or ../@type = 'netdemand'">
                                        <G_SG21>
                                            <S_RFF>
                                                <C_C506>
                                                  <D_1153>AEH</D_1153>
                        ...
                        <xsl:for-each select="Contact[@role != 'BuyerPlannerCode']">
                            <xsl:if test="@role != ''">
                                <G_SG24>
                                    ...
                                    <xsl:call-template name="CTACOMLoop">
                                        ...
                                        <xsl:with-param name="ContactPerson" select="Name"/>
                        ...
                        <xsl:for-each select="Contact[@role = 'BuyerPlannerCode']">
                            <xsl:if test="@role != ''">
                                <G_SG24>
                                    <xsl:call-template name="createNAD">
                                        <xsl:with-param name="Address" select="."/>
                                        <xsl:with-param name="role" select="'BuyerPlannerCode'"/>
                                    </xsl:call-template>
                                    <xsl:call-template name="CTACOMLoop">
                                        <xsl:with-param name="contact" select="."/>
                                        ...
                                        <xsl:with-param name="ContactDepartmentID"
                                            select="IdReference[@domain = 'BuyerPlannerCode']/@identifier"/>
                                        <xsl:with-param name="ContactPerson"
                                            select="IdReference[@domain = 'BuyerPlannerCode']/Description"/>
                                        <xsl:with-param name="level" select="'detail'"/>
                                        <xsl:with-param name="isJITorFOR" select="'true'"/>
                                    </xsl:call-template>
                                </G_SG24>
