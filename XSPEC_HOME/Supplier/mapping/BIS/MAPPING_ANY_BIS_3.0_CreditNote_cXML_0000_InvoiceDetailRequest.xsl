...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="Lookup" select="document('pd:HCIOWNERPID:LOOKUP_BIS_3.0.xml:Binary')"/>
  ...
  <!--  <xsl:variable name="Lookup" select="document('LOOKUP_BIS_3.0.xml')"/>
    ...
    <xsl:template match="*">
        ...
        <xsl:variable name="invType">
            <xsl:choose>
                <xsl:when test="cbc:CreditNoteTypeCode = '81'">lineLevelCreditMemo</xsl:when>
                <xsl:when test="cbc:CreditNoteTypeCode = '83'">lineLevelCreditMemo</xsl:when>
                <xsl:when test="cbc:CreditNoteTypeCode = '381'">lineLevelCreditMemo</xsl:when>
                <xsl:when test="cbc:CreditNoteTypeCode = '396'">lineLevelCreditMemo</xsl:when>
                <xsl:when test="cbc:CreditNoteTypeCode = '532'">lineLevelCreditMemo</xsl:when>
            </xsl:choose>
        </xsl:variable>
                ...
                <InvoiceDetailRequest>
                    <InvoiceDetailRequestHeader>
                        ...
                        <InvoiceDetailLineIndicator>
                            <xsl:if
                                test="cac:CreditNoteLine/cac:AllowanceCharge[cbc:ChargeIndicator = 'false' and cbc:AllowanceChargeReasonCode = '95']/cbc:Amount != ''">
                                <xsl:attribute name="isDiscountInLine">yes</xsl:attribute>
                            </xsl:if>
                            <xsl:if
                                test="cac:CreditNoteLine/cac:AllowanceCharge[cbc:ChargeIndicator = 'true' and cbc:AllowanceChargeReasonCode = 'SAA']/cbc:Amount != ''">
                                <xsl:attribute name="isShippingInLine">yes</xsl:attribute>
                            </xsl:if>
                            <xsl:if
                                test="cac:CreditNoteLine/cac:AllowanceCharge[cbc:ChargeIndicator = 'true' and cbc:AllowanceChargeReasonCode = 'SH']/cbc:Amount != ''">
                        ...
                        <xsl:if test="cac:Delivery">
                            <InvoiceDetailShipping>
                                ...
                                <Contact>
                                    ...
                                    <Name>
                                        <xsl:attribute name="xml:lang">en</xsl:attribute>Not Provided</Name>
                                    <PostalAddress>
                                        <xsl:choose>
                                            <xsl:when
                                                test="cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:StreetName != '' or cac:Delivery/cac:DeliveryLocation/cac:Address/cbc:AdditionalStreetName != '' or cac:Delivery/cac:DeliveryLocation/cac:Address/cac:AddressLine != '' or cac:Delivery/cac:DeliveryLocation/cac:Address/cac:AddressLine/cbc:Line != ''">
                    ...
                    <InvoiceDetailOrder>
                        ...
                        <xsl:if
                            test="cac:CreditNoteLine[1]/cac:DocumentReference[cbc:ID/@schemeID = 'MA']/cbc:ID != ''">
                            <InvoiceDetailShipNoticeInfo>
                                <ShipNoticeReference>
                                    <xsl:attribute name="shipNoticeID">
                                        <xsl:value-of
                                            select="cac:CreditNoteLine[1]/cac:DocumentReference[cbc:ID/@schemeID = 'MA']/cbc:ID"
                                        />
                                    </xsl:attribute>
                                    <DocumentReference>
                                        <xsl:attribute name="payloadID"> </xsl:attribute>
                        ...
                        <!--<xsl:for-each select="cac:CreditNoteLine">
                            <xsl:call-template name="LineItem">
                                ...
                                <xsl:with-param name="Type" select="'CreditNote'"/>
                            </xsl:call-template>
                        </xsl:for-each>-->
                        <xsl:for-each select="cac:CreditNoteLine">
                            <xsl:choose>
